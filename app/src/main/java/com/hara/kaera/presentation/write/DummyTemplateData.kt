...
object DummyTemplateData {
    val templateList = listOf<TemplateData>(
        ...
        TemplateData(2, "세번의 왜?", "내 고민 속 물음의 꼬리를 통해 해결책을 찾아가요.", false),
        TemplateData(3, "걱정을 극복하는 <자기관리론>", "데일 카네기가 제시한 방법에 따라 걱정을 극복해보세요.", false),
        TemplateData(4, "단 하나의 목표", "내 고민의 우선순위를 통해 생각을 정리해보세요.", false),
        TemplateData(5, "땡스투 새겨보기", "부정을 긍정으로, 사고를 전환해보세요.", false),
        TemplateData(6, "10 - 10 - 10", "시간을 기준으로 내 고민의 미래를 생각해보세요.", false),
    )
}