    ...
    this.apply {
        if (hasUsed) {
            when (templateId) {
                ...
                3 -> {setImageResource(R.drawable.gem_blue_s_on)}
                4 -> {setImageResource(R.drawable.gem_green_s_on)}
                5 -> {setImageResource(R.drawable.gem_yellow_s_on)}
            ...
            when (templateId) {
                ...
                3 -> {setImageResource(R.drawable.gem_blue_s_off)}
                4 -> {setImageResource(R.drawable.gem_green_s_off)}
                5 -> {setImageResource(R.drawable.gem_yellow_s_off)}
                else -> {setImageResource(R.drawable.icn_warningrt)}
            }
        }
    }
