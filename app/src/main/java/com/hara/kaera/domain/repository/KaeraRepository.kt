...
interface KaeraRepository {
    ...
    fun editDeadline(editDeadlineReqDTO: EditDeadlineReqDTO): Flow<ApiResult<EditDeadlineResDTO>>

    fun writeWorry(writeWorryReqDTO: WriteWorryReqDTO): Flow<ApiResult<WriteWorryResDTO>>
